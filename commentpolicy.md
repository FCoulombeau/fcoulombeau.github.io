...
Des smileys sont aussi disponibles. L'ensemble des smileys supportés se trouve [l� ](https://www.webpagefx.com/tools/emoji-cheat-sheet/). On peut aussi (avec certains navigateurs) les obtenir avec un simple clic droit. Parmi les plus courants :
