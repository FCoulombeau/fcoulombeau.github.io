...
Concernant le nouvel algorithme que j'ai présenté plus haut, voici la comparaison entre les nombres de cas prédits par l'interpolation et l'interpolation pessimiste depuis le 10 mars jusqu'au 14 mars :
