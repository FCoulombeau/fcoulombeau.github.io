...
[(Mise-à-jour le 25 mars au soir)](#mise-à-jour-du-25-mars-au-soir)
...
La prévision s'est avérée exacte aujourd'hui. C'est un hasard. Mais le modèle m'apparaît - de plus en plus - étonnamment valide. J'ai aussi continuer à faire la modélisation du nombre de COVID+ et là aussi, après un jour erratique, le modèle se comporte très bien.
