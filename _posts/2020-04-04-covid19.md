...
[(Situation au 3 avril au soir)](#situation-au-3-avril)
...
$$P_i=L_i^2\left(1-\frac{L_i}{c}\right)^2\text{~~;~~}\overline{L}=\dfrac{\displaystyle\sum_iP_iL_i}{\displaystyle\sum_iP_i}\text{~~;~~}\overline{X}=\dfrac{\displaystyle\sum_iP_iX_i}{\displaystyle\sum_iP_i}$$

$$\overline{A}=\displaystyle\sum_iP_i\left(X_i-\overline{X}\right)\left(2X_i-\overline{X}\right)\text{~~;~~}\overline{B}=\displaystyle\sum_iP_i\left(3X_i-2\overline{X}\right)\left(\overline{L}-L_i\right)$$

$$\overline{C}=\displaystyle\sum_iP_i\left(\overline{L}-L_i\right)^2\text{~~;~~}\overline{\Delta}=\overline{B}^2-4\overline{A}\overline{C}$$
...
Elle donne pour les résultats suivants pour la valeurs de $a$ (celle de $b$ restant inchangée) :
...
L'erreur que j'ai commise revient à minimiser $a\mapsto aS(a)$ en cherchant une valeur du paramètre $a$ **_strictement positif_** pour laquelle cette fonction passe par un minimum local. Ceci a pour effet de sous-évaluer la valeur optimale du paramètre $a$ et à stabiliser l'algorithme (pour des raisons que je ne développe pas).
...
[![CoViD-19 sigmoïdale, évolution du nombre de cas](/img/CasVsSimulFR03042020b.png)](/img/CasVsSimulFR04042020b.png)
