...
2. Aller le dossier d'installation de Python, puis dans le sous-dossier `Scripts`.
...
Si cette dernière étape s'effectue correctement, vous disposerez de vidéos de vos courses, sinon, vous n'aurez que les images de la courses.
