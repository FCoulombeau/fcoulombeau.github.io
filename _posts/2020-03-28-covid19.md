...
Ici les abscisses $\left(X_i\right)_{1\leq i\leq n}$ sont les dates des mesures effectuées et $\left(Y_i\right)_{1\leq i\leq n}$ le nombres de malades fournis par les gouvernement jour après jour.
